...
loader = WebBaseLoader(
   web_paths=["https://www.educosys.com/"]
)
docs = loader.load()
...
def retrieve_context(query: str):
   """Search for info related to educosys course"""
   print("Inside Retrieving context...retrieve_context")
   try:
       embeddings = GoogleGenerativeAIEmbeddings(model="models/gemini-embedding-001")
       vector_store = Chroma(
...
input_message = (
   "Give me topics taught in educosys using retrieve_context tool "
)
